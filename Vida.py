...
pygame.display.set_caption("Juego de la vida - Fedeloz")
...
# Versión de mi autómata que siempre aparece centrada: Autómata Fedeloz :)
...
gameState[posInitX + 5, posInitY - 3] = 1
gameState[posInitX + 6, posInitY - 3] = 1
gameState[posInitX + 7, posInitY - 3] = 1
gameState[posInitX + 8, posInitY - 3] = 1
gameState[posInitX + 9, posInitY - 3] = 1
gameState[posInitX + 10, posInitY - 3] = 1
gameState[posInitX + 11, posInitY - 3] = 1
gameState[posInitX + 12, posInitY - 3] = 1

gameState[posInitX, posInitY] = 1
gameState[posInitX + 1, posInitY - 2] = 1
gameState[posInitX + 2, posInitY - 2] = 1
gameState[posInitX + 3, posInitY - 2] = 1
gameState[posInitX + 4, posInitY - 2] = 1
gameState[posInitX + 5, posInitY - 2] = 1
gameState[posInitX + 6, posInitY - 2] = 1
gameState[posInitX + 7, posInitY - 2] = 1
gameState[posInitX + 8, posInitY - 2] = 1
gameState[posInitX + 9, posInitY - 2] = 1
gameState[posInitX + 10, posInitY - 2] = 1
gameState[posInitX + 11, posInitY - 2] = 1
gameState[posInitX + 12, posInitY - 2] = 1

gameState[posInitX, posInitY] = 1
gameState[posInitX + 1, posInitY - 1] = 1
gameState[posInitX + 2, posInitY - 1] = 1
gameState[posInitX + 3, posInitY - 1] = 1
gameState[posInitX + 4, posInitY - 1] = 1
gameState[posInitX + 5, posInitY - 1] = 1
gameState[posInitX + 6, posInitY - 1] = 1
gameState[posInitX + 7, posInitY - 1] = 1
gameState[posInitX + 8, posInitY - 1] = 1
gameState[posInitX + 9, posInitY - 1] = 1
gameState[posInitX + 10, posInitY - 1] = 1
gameState[posInitX + 11, posInitY - 1] = 1
gameState[posInitX + 12, posInitY - 1] = 1


# Horizontal 2

gameState[posInitX, posInitY +1] = 1
gameState[posInitX + 1, posInitY + 2] = 1
gameState[posInitX + 2, posInitY + 2] = 1
gameState[posInitX + 3, posInitY + 2] = 1
gameState[posInitX + 4, posInitY + 2] = 1
...
gameState[posInitX, posInitY + 8] = 1
gameState[posInitX, posInitY + 7] = 1
gameState[posInitX, posInitY + 6] = 1
gameState[posInitX, posInitY + 5] = 1
...
gameState[posInitX - 1, posInitY + 8] = 1
gameState[posInitX - 1, posInitY + 7] = 1
gameState[posInitX - 1, posInitY + 6] = 1
gameState[posInitX - 1, posInitY + 5] = 1
...
gameState[posInitX - 2, posInitY + 8] = 1
gameState[posInitX - 2, posInitY + 7] = 1
gameState[posInitX - 2, posInitY + 6] = 1
gameState[posInitX - 2, posInitY + 5] = 1
...
while not endGame:
    ...
    title = f"Juego de la vida - Fedeloz_Bot - Población: {population} - Generación: {iteration}"
    if pauseExec:
        title += " - [PAUSADO]"
